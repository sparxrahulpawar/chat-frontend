...
const Message = ({ userId }) => {
  const messages = [
    ...
    { id: 3, sender: "User 1", text: "I'm good, thanks! And you?", time: "10:02 AM" },
    // Add more messages as needed
  ];

  return (
    <div className="flex flex-col h-screen bg-message-theme"> {/* Use the theme class here */}
        ...
        {messages.map((message) => (
          <div
            ...
            className={`p-3 rounded-lg flex items-end ${
              message.sender === "User 1" ? "bg-blue-200 ml-auto" : "bg-gray-200 mr-auto"
            }`}
            style={{ maxWidth: "40%", width: "fit-content", wordWrap: "break-word" }} // Set max width to 40% and adjust width
          >
